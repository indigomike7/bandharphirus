        ...
        <div class="row align-items-center mb-3">
            <div class="col-sm">
                <h1 class="page-header-title"><?php echo e(trans('messages.Orders')); ?> <span
                        class="badge badge-soft-dark ml-2"><?php echo e(\App\Model\OrderDetail::where('seller_id',auth('seller')->id())->count()); ?></span>
                </h1>
...
<?php echo $__env->make('layouts.back-end.app-seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bandbkmp/public_html/resources/views/seller-views/order/list.blade.php ENDPATH**/ ?>