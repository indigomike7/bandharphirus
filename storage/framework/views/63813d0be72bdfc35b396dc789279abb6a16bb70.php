<?php $__env->startSection('title','Update Saldo'); ?>
...
<?php endif; ?>                        <div class="card-body row">
							...
							<?php echo e($sp->saldo1); ?><br/>
							Cost : <?php echo e($sp->saldo1); ?><br/>
                                <input type="hidden" name="saldo1" value="<?php echo e($sp->saldo1); ?>" class="form-control" id="saldo1">
                            ...
                            <div class="form-group col-md-2" style="border:1px solid black; margin:30px;">
							<?php echo e($sp->saldo2); ?><br/>
							Cost : <?php echo e($sp->saldo2); ?><br/>
                                <input type="hidden" name="saldo2" value="<?php echo e($sp->saldo2); ?>" class="form-control" id="saldo2" >
                            ...
                            <div class="form-group col-md-2" style="border:1px solid black;  margin:30px;">
							<?php echo e($sp->saldo3); ?><br/>
							Cost : <?php echo e($sp->saldo3); ?><br/>
                                <input type="hidden" name="saldo3" value="<?php echo e($sp->saldo3); ?>" class="form-control" id="saldo3" >
                            ...
                            <div class="form-group col-md-2" style="border:1px solid black;  margin:30px;">
							<?php echo e($sp->saldo4); ?><br/>
							Cost : <?php echo e($sp->saldo4); ?><br/>
								<input type="hidden" name="saldo4" value="<?php echo e($sp->saldo4); ?>" class="form-control" id="saldo4">
									...
									<div class="card">
										<div class="card-body" style="height: 100px">
											<a class="btn btn-block"
											   href="javascript:modalview('<?php echo e($data['data'][$i]['code']); ?>',$('#saldo1').val());">
							...
							<?php for($i=0;$i<count($data['data']);$i++): ?>
								<div class="col-md-3" style="cursor: pointer">
									<div class="card">
										<div class="card-body" style="height: 100px">
											<a class="btn btn-block"
											   href="javascript:modalview('<?php echo e($data['data'][$i]['code']); ?>',$('#saldo2').val());">
												<?php echo e($data['data'][$i]['name']); ?> <br/>Code : <?php echo e($data['data'][$i]['code']); ?>
							...
							<?php for($i=0;$i<count($data['data']);$i++): ?>
								<div class="col-md-3" style="cursor: pointer">
									<div class="card">
										<div class="card-body" style="height: 100px">
											<a class="btn btn-block"
											   href="javascript:modalview('<?php echo e($data['data'][$i]['code']); ?>',$('#saldo3').val());">
												<?php echo e($data['data'][$i]['name']); ?> <br/>Code : <?php echo e($data['data'][$i]['code']); ?>
							...
							<?php for($i=0;$i<count($data['data']);$i++): ?>
								<div class="col-md-3" style="cursor: pointer">
									<div class="card">
										<div class="card-body" style="height: 100px">
											<a class="btn btn-block"
											   href="javascript:modalview('<?php echo e($data['data'][$i]['code']); ?>',$('#saldo4').val());">
												<?php echo e($data['data'][$i]['name']); ?> <br/>Code : <?php echo e($data['data'][$i]['code']); ?>
...
<?php echo $__env->make('layouts.back-end.app-seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bandbkmp/public_html/resources/views/seller-views/saldo/update.blade.php ENDPATH**/ ?>