<?php $__env->startSection('title','Add New Education Category'); ?>
    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form class="product-form" action="<?php echo e(route('admin.education.categoryaddnew2')); ?>" method="post" enctype="multipart/form-data"
                      id="product_form">
                    <?php echo csrf_field(); ?>
                    <div class="card">
                        <div class="card-header">
                            <h4>Add New Education Category</h4>
                        </div>
                       <div class="card-body">
                            <div class="form-group">
                                <label for="name">Education Category</label>
                                <input type="text" name="category" value="<?php echo e(old('category')); ?>" class="form-control" id="category" placeholder="Ex : Kontes untuk memperingati HUT RI">
                            </div>
...
<?php $__env->startPush('script'); ?>
    ...
    <script>
        $('#product_form').submit(function (e) {
            ...
            $.post({
                url: '<?php echo e(route('admin.education.categoryaddnew2')); ?>',
                data: formData,
                contentType: false,
                processData: false,
                success: function (data) {
                    if (data.errors) {
                        ...
                        toastr.success('Education Category added successfully!', {
                            CloseButton: true,
                            ProgressBar: true
                        });
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bandbkmp/public_html/resources/views/admin-views/education/categoryadd.blade.php ENDPATH**/ ?>