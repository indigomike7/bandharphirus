    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3"> 
                ...
                <div style="font-size: 20px; font-weight: 600; " class="for-tab-display">☰ <?php echo e(trans('messages.Open Sidebar')); ?></div>
            </a></div>
            <div class="col-md-9">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <h1 class="h3 text-dark mb-3 headerTitle text-uppercase"><?php echo e($data['data_from']); ?> <?php echo e(trans('messages.products')); ?> <?php echo e(isset($brand_name) ? '('.$brand_name.')' : ''); ?></h1>
                    </div>
                    <div class="col-md-6 for-display">

                        <button class="openbtn" onclick="openNav()">
                            <div style="margin-bottom: -30%;">☰ <?php echo e(trans('messages.Open Sidebar')); ?></div>
                        </button>


                        <div class="d-flex flex-wrap mt-5 float-right for-shoting-mobile">
                            <form class="" id="search-form" action="<?php echo e(route('products')); ?>" method="GET">
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bandbkmp/public_html/resources/views/web-views/products/view.blade.php ENDPATH**/ ?>