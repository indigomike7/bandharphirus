    ...
    <section class="bg-transparent mt-4 mb-4">
        <div class="container">
            <div class="row ">
				...
				<div class="row">
				<div class="col-md-12">
				<a href="<?php echo e(route('educationcategory')); ?>">Education</a> / <a href="<?php echo e(route('educationcategoryid',[$ec->id])); ?>"><?php echo e($ec->category); ?></a> / <?php echo e($e->title); ?>

				<br><br>
				<h3><?php echo e($e->title); ?></h3></a>
				<?php if($e->picture!=null || $e->picture!=""): ?>
					<?php $__currentLoopData = json_decode($e->picture); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2 => $photo2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<div class="card">
								<div class="card-body">
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bandbkmp/public_html/resources/views/web-views/educationid.blade.php ENDPATH**/ ?>