    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a href="<?php echo e(route('admin.education.list')); ?>">Education</a></li>
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-2">
            <h1 class="h3 mb-0 text-black-50">Edit Education</h1>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form class="product-form" action="<?php echo e(route('admin.education.update')); ?>" method="post" enctype="multipart/form-data"
                      id="product_form">
                    <?php echo csrf_field(); ?>
                    <div class="card">
...
<?php endif; ?>                        <div class="card-body">
                            <div class="form-group">
								...
								<option value="<?php echo e($value->id); ?>" <?php echo e(($value->id==$e->category) ? " selected='selected' " : ""); ?>><?php echo e($value->category); ?></option>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								</select>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" name="title" value="<?php echo e($e->title); ?>" class="form-control" id="name" placeholder="Ex : Kontes untuk memperingati HUT RI">
                            </div>

                            <div class="form-group">
                                <label for="name">Description</label>
                                <textarea name="description" class="form-control" id="description" ><?php echo e($e->description); ?>
                                ...
                                <div class="p-2 border border-dashed"  style="max-width:430px;">
									...
									<?php if($e->picture!=null): ?>
                                    <?php $__currentLoopData = json_decode($e->picture); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-6">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <a href="<?php echo e(route('admin.education.remove_image',['id'=>$e['id'],'image'=>$photo])); ?>"
...
<?php $__env->startPush('script'); ?>
    ...
    <script>
        $('#product_form').submit(function (e) {
            ...
            $.post({
                url: '<?php echo e(route('admin.education.update')); ?>',
                data: formData,
                contentType: false,
                processData: false,
                success: function (data) {
                    if (data.errors) {
                        ...
                        setInterval(function () {
                            location.href = '<?php echo e(route('admin.education.list')); ?>';
                        }, 2000);
                    }
                }
            });
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bandbkmp/public_html/resources/views/admin-views/education/edit.blade.php ENDPATH**/ ?>