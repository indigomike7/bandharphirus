...
<?php endif; ?>                        <div class="card-body">
							...
							<h4><?php echo e($contest->name); ?></h4>
							Category :
							<?php $__currentLoopData = $contestcat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<?php if($value->id==$contest->contestcat): ?>
							<?php echo e($value->category); ?><br/>
							<?php endif; ?>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							<?php echo e($contest->description); ?><br/>
							Biaya : <?php echo e($contest->fund); ?><br/>
							Dimulai tanggal <?php echo e($contest->start_date!==null ? $contest->start_date->format('Y-m-d') : 'N/A'); ?><br/>
							Berakhir tanggal <?php echo e($contest->end_date!==null ? $contest->end_date->format('Y-m-d') : 'N/A'); ?><br/>
							Dimulai tanggal <?php echo e($contest->start_date_1!==null ? $contest->start_date_1 : 'N/A'); ?> Tiap Bulan<br/>
							Berakhir tanggal <?php echo e($contest->end_date_1!==null ? $contest->end_date_1 : 'N/A'); ?> Tiap Bulan<br/>
							Dimulai tanggal <?php echo e($contest->start_date_2!==null ? $contest->start_date_2 : 'N/A'); ?> Tiap Bulan<br/>
							Berakhir tanggal <?php echo e($contest->end_date_2!==null ? $contest->end_date_2 : 'N/A'); ?> Tiap Bulan<br/>
							Dimulai tanggal <?php echo e($contest->start_date_3!==null ? $contest->start_date_3 : 'N/A'); ?> Tiap Bulan<br/>
							Berakhir tanggal <?php echo e($contest->end_date_3!==null ? $contest->start_date_3 : 'N/A'); ?> Tiap Bulan<br/>
                ...
                <form class="product-form" action="<?php echo e(route('seller.contest.updatemanage')); ?>" method="post" enctype="multipart/form-data"
                      id="product_form">
                    <div class="card mt-2">
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12" style="padding-top: 20px">
										<div class="form-group">
											...
											<textarea name="result" class="form-control" id="result" ><?php echo e($contest->result); ?>
					...
					<!-- LISTING -->
								...
								<?php (
									...
									<?php if(!empty($contestuser2)): ?>
										<?php $__currentLoopData = $contestuser2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		                                    <div class="col-md-6" style="padding-top: 20px">
												<div class="form-group">
											<?php if($detail->user_id!=null): ?>
											<?php (
											$userobj=$user->where('id','=',$detail->user_id)->first()
											); ?>
											Buyer Name : <?php echo e($userobj->f_name); ?> <?php echo e($userobj->l_name); ?><br/>
											<?php endif; ?>
											<?php if($detail->seller_id!=null): ?>
											<?php (
...
<?php $__env->startPush('script'); ?>
    ...
    <script>
        $('#product_form').submit(function (e) {
            ...
            $.post({
                url: '<?php echo e(route('seller.contest.updatemanage')); ?>',
                data: formData,
                contentType: false,
                processData: false,
                success: function (data) {
                    if (data.errors) {
                        ...
                        setInterval(function () {
                            location.href = '<?php echo e(route('seller.contest.listmanage',$contest->id)); ?>';
                        }, 2000);
                    }
                }
            });
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.back-end.app-seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bandbkmp/public_html/resources/views/seller-views/contest/view.blade.php ENDPATH**/ ?>