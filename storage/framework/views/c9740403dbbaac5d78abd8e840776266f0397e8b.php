...
<div class="content container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-2">
        <h1 class="h3 mb-0 text-black-50"> <?php echo e(trans('messages.Banner')); ?></h1>
    </div>
    <div class="row">
        <div class="col-md-12" id="banner-btn">
            <button id="main-banner-add" class="btn btn-primary"><i class="tio-add-circle"></i> <?php echo e(trans('messages.add_main_banner')); ?></button>
            <button id="secondary-banner-add"
                    class="btn btn-primary ml-2"><i class="tio-add-circle"></i> <?php echo e(trans('messages.add_secondary_banner')); ?></button>
            <button id="popup-banner-add"
                    class="btn btn-primary ml-2 propup"><i class="tio-add-circle"></i>  <?php echo e(trans('messages.add_popup_banner')); ?></button>
        </div>
    </div>
    <!-- Content Row -->
    <div class="row pt-4" id="main-banner" style="display: none">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.banner.store')); ?>" method="post" enctype="multipart/form-data" class="banner_form">
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <label for="name"><?php echo e(trans('messages.Image')); ?></label><br>
                                    <div class="custom-file">
                                        <input type="file" name="image" id="mbimageFileUploader" class="custom-file-input"
                                            accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <label class="custom-file-label" for="mbimageFileUploader"><?php echo e(trans('messages.choose')); ?> <?php echo e(trans('messages.file')); ?></label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <center>
                        ...
                        <div class="card-footer">
                            ...
                            <button id="add" type="submit" class="btn btn-primary"><?php echo e(trans('messages.save')); ?></button>
    ...
    <div class="row pt-4" id="secondary-banner" style="display: none">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="banner_form" action="<?php echo e(route('admin.banner.store')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" name="image" id="fbimageFileUploader" class="custom-file-input"
                                            accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <label class="custom-file-label" for="fbimageFileUploader"><?php echo e(trans('messages.choose')); ?> <?php echo e(trans('messages.file')); ?></label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <center>
                        ...
                        <div class="card-footer">
                            <a class="btn btn-secondary text-white cancel"><?php echo e(trans('messages.Cancel')); ?></a>
                            <button type="submit" id="addfooter" class="btn btn-primary"><?php echo e(trans('messages.save')); ?></button>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <label for="name"><?php echo e(trans('messages.Image')); ?></label>
                                    <br>
                                    <div class="custom-file">
                                        <input type="file" name="image" id="pbimageFileUploader" class="custom-file-input"
                                            accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <label class="custom-file-label" for="pbimageFileUploader"><?php echo e(trans('messages.choose')); ?> <?php echo e(trans('messages.file')); ?></label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <center>
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bandbkmp/public_html/resources/views/admin-views/banner/view.blade.php ENDPATH**/ ?>