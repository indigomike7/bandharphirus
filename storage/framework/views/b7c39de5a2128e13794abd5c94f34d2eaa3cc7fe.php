                            ...
                            <ul class="list-group">
                                <?php $__currentLoopData = $shipping_addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="list-group-item mb-2 mt-2"
                                        ...
                                        <label class="badge" style="background: <?php echo e($web_config['primary_color']); ?>; color:white !important;"><?php echo e($address['address_type']); ?></label>
                                        <small>
                                        ...
                                        <span><?php echo e(trans('messages.address')); ?> : <?php echo e($address['address']); ?>, <?php echo e($address['city']); ?>, <?php echo e($address['zip']); ?></span>
                                    </li>
                                ...
                                <li class="list-group-item mb-2 mt-2" onclick="anotherAddress()">
                                    ...
                                    <span class="checkmark" style="margin-right: 10px"></span>
                                    <label class="badge" style="background: <?php echo e($web_config['primary_color']); ?>; color:white !important;">
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bandbkmp/public_html/resources/views/web-views/checkout-shipping.blade.php ENDPATH**/ ?>