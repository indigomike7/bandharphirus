...
<?php endif; ?>                        <div class="card-body">
                ...
                <form class="product-form" action="<?php echo e(route('admin.contest2.updatemanage')); ?>" method="post" enctype="multipart/form-data"
                      id="product_form">
                    <div class="card mt-2">
                        <div class="card-body">
                            <div class="form-group">
...
<?php $__env->startPush('script'); ?>
    ...
    <script>
        $('#product_form').submit(function (e) {
            ...
            $.post({
                url: '<?php echo e(route('admin.contest2.updatemanage')); ?>',
                data: formData,
                contentType: false,
                processData: false,
                success: function (data) {
                    if (data.errors) {
                        ...
                        setInterval(function () {
                            location.href = '<?php echo e(route('admin.contest2.listmanage',$contest->id)); ?>';
                        }, 2000);
                    }
                }
            });
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bandbkmp/public_html/resources/views/admin-views/contest/view.blade.php ENDPATH**/ ?>