        ...
        <div class="row justify-content-center">
            <div class="col-md-7 col-lg-5">
                ...
                <div class="card card-lg mb-5">
                    <div class="card-body">
                        <!-- Form -->
                        <form class="js-validate" action="<?php echo e(route('seller.auth.login')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                    ...
                    <?php if(env('APP_MODE')=='demo'): ?>
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-10">
                                    <span>Email : seller_demo@demo.com</span><br>
...
<?php /**PATH D:\xampp-php-8.0.8\htdocs\bandharphirus.com-newdesign-2021-08-06\resources\views/seller-views/auth/login.blade.php ENDPATH**/ ?>