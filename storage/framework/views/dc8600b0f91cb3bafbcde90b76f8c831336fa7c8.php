<?php $__env->startSection('title','Add My Barter'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="content container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-2">
            <h1 class="h3 mb-0 text-black-50">Add My Barter</h1>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form class="product-form" action="<?php echo e(route('admin.barter.addnew')); ?>" method="post" enctype="multipart/form-data"
                      id="product_form">
                    <?php echo csrf_field(); ?>
                    <div class="card">
                        <div class="card-header">
                            <h4>Add My New Barter</h4>
                        </div>
                      <div class="card-body">
...
-->
    ...
    <script>
        $('#product_form').submit(function (e) {
            ...
            $.post({
                url: '<?php echo e(route('admin.barter.addnew')); ?>',
                data: formData,
                contentType: false,
                processData: false,
                success: function (data) {
                    if (data.errors) {
                        ...
                        toastr.success('Barter added successfully!', {
                            CloseButton: true,
                            ProgressBar: true
                        });
                        setInterval(function () {
                            location.href = '<?php echo e(route("admin.barter.list")); ?>';
                        }, 2000);
                    }
                }
            });
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bandbkmp/public_html/resources/views/admin-views/barter/adminadd.blade.php ENDPATH**/ ?>