...
<table class="table table-bordered">
    ...
    <?php $__currentLoopData = $combinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $combination): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            ...
            <td>
                <input type="number" name="qty_<?php echo e($combination['type']); ?>" value="<?php echo e($combination['qty']); ?>" min="1" max="100000" step="1"
                       class="form-control"
                       required>
            </td>
        </tr>
...
<?php /**PATH /home/bandbkmp/public_html/resources/views/admin-views/product/partials/_edit_sku_combinations.blade.php ENDPATH**/ ?>