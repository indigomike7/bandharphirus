...
<div class="content container-fluid">
    ...
    <div class="d-md-flex_ align-items-center justify-content-between mb-2">
       <div class="row">
           <div class="col-md-8">
               <h3 class="h3 mb-0 text-gray-800"><?php echo e(trans('Product List')); ?></h3>
           </div>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item"
                                                   href="<?php echo e(route('seller.product.edit',[$p['id']])); ?>"><?php echo e(trans('messages.Edit')); ?></a>
                                                <a class="dropdown-item" href="javascript:"
                                                onclick="form_alert('product-<?php echo e($p['id']); ?>','Want to delete this item ?')"><?php echo e(trans('messages.Delete')); ?></a>
...
<?php echo $__env->make('layouts.back-end.app-seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bandbkmp/public_html/resources/views/seller-views/product/list.blade.php ENDPATH**/ ?>