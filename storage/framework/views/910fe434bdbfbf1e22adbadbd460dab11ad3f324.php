                        ...
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="layoutSkinsRadio1">
                                <img class="custom-checkbox-card-img"
                                     src="<?php echo e(asset('public/assets/admin')); ?>/svg/layouts/layouts-sidebar-default.svg"
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="layoutSkinsRadio2">
                                <img class="custom-checkbox-card-img"
                                     src="<?php echo e(asset('public/assets/admin')); ?>/svg/layouts/layouts-sidebar-dark.svg"
                                     alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="layoutSkinsRadio3">
                                <img class="custom-checkbox-card-img"
                                     src="<?php echo e(asset('public/assets/admin')); ?>/svg/layouts/layouts-sidebar-light.svg"
                                     alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="sidebarLayoutOptions1">
                                <img class="custom-checkbox-card-img"
                                     src="<?php echo e(asset('public/assets/admin')); ?>/svg/layouts/sidebar-default-classic.svg"
                                     alt="Image Description">
                            </label>
                            <span class="custom-checkbox-card-text">Default</span>
                        </div>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="sidebarLayoutOptions2">
                                <img class="custom-checkbox-card-img"
                                     src="<?php echo e(asset('public/assets/admin')); ?>/svg/layouts/sidebar-compact.svg"
                                     alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="sidebarLayoutOptions3">
                                <img class="custom-checkbox-card-img"
                                     src="<?php echo e(asset('public/assets/admin')); ?>/svg/layouts/sidebar-mini.svg"
                                     alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="headerLayoutOptions1">
                                <img class="custom-checkbox-card-img"
                                     src="<?php echo e(asset('public/assets/admin')); ?>/svg/layouts/header-default-fluid.svg"
                                     alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="headerLayoutOptions2">
                                <img class="custom-checkbox-card-img"
                                     src="<?php echo e(asset('public/assets/admin')); ?>/svg/layouts/header-default-container.svg"
                                     alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="headerLayoutOptions3">
                                <img class="custom-checkbox-card-img"
                                     src="<?php echo e(asset('public/assets/admin')); ?>/svg/layouts/header-double-line-fluid.svg"
                                     alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="headerLayoutOptions4">
                                <img class="custom-checkbox-card-img"
                                     src="<?php echo e(asset('public/assets/admin')); ?>/svg/layouts/header-double-line-container.svg"
                                     alt="Image Description">
                            </label>
...
<?php /**PATH D:\xampp-php-8.0.8\htdocs\bandharphirus.com-newdesign-2021-08-06\resources\views/layouts/back-end/partials/_front-settings.blade.php ENDPATH**/ ?>