        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4">
                <?php $__currentLoopData = \App\CPU\CategoryManager::parents(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card-header mb-2 p-2" onclick="get_categories('<?php echo e(route('category-ajax',[$category['id']])); ?>')" style="border: 1px solid black; border-radius: 6px; cursor: pointer;">
                        <img src="<?php echo e(asset("storage/app/public/category/$category->icon")); ?>" onerror="this.src='<?php echo e(asset('public/assets/front-end/img/image-place-holder.png')); ?>'" style="width: 18px; height: 18px; margin-right: 5px;">
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bandbkmp/public_html/resources/views/web-views/categories.blade.php ENDPATH**/ ?>