        ...
        <div class="container">
            <div class="row ">
                <div class="col-12">
                        <div class="row">
				<div class="col-md-4">
				<h3><?php echo e($collection3->name); ?></h3></a>
				<p><?php echo e($collection3->description); ?></p>
				<?php if($collection3->pictures!=null || $collection3->pictures!=""): ?>
					<?php $__currentLoopData = json_decode($collection3->pictures); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2 => $photo2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<div class="card">
								<div class="card-body">
				...
				<h6 class="flash-product-title">
					<a href="<?php echo e(route('product',$value->slug)); ?>"><?php echo e($value['name']); ?></a>
				</h6>
                <a href="<?php echo e(route('product',$value->slug)); ?>"><img src="<?php echo e(\App\CPU\ProductManager::product_image_path('thumbnail')); ?>/<?php echo e($value['thumbnail']); ?>"
                     onerror="this.src='<?php echo e(asset('public/assets/front-end/img/image-place-holder.png')); ?>'"
                     style="height: 180px;"></a>
				<div class="flash-product-price">
					<?php echo e(\App\CPU\Helpers::currency_converter($value->unit_price-\App\CPU\Helpers::get_product_discount($value,$value->unit_price))); ?>

					<?php if($value->discount > 0): ?>
						<strike
							style="font-size: 12px!important;color: grey!important;">
							<?php echo e(\App\CPU\Helpers::currency_converter($value->unit_price)); ?>
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bandbkmp/public_html/resources/views/web-views/collectionid.blade.php ENDPATH**/ ?>