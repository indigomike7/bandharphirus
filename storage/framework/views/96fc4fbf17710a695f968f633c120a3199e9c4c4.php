        ...
        <div class="widget widget-cart px-3 pt-2 pb-3">
            ...
            <?php else: ?>
                <div class="widget-cart-item">
                    <h6 class="text-danger text-center"><i class="fa fa-cart-arrow-down"></i> <?php echo e(trans('messages.Empty')); ?> <?php echo e(trans('messages.Cart')); ?> </h6>
                </div>
            <?php endif; ?>
        </div>
    </div>
...
<?php /**PATH /home/bandbkmp/public_html/resources/views/layouts/front-end/partials/cart.blade.php ENDPATH**/ ?>