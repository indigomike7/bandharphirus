...
<div class="sidebarR col-lg-3 col-md-3">
    ...
    <div class="price_sidebar rounded-lg box-shadow-sm" id="shop-sidebar" style="margin-bottom: -10px;">
        ...
        <div class="pb-0" style="padding-top: 12px;">
            ...
            <div class="sidebarL">
                <h3 class="widget-title btnF" style="font-weight: 700;">
                    <a class="<?php echo e(Request::is('track-order*')?'active-menu':''); ?>" href="<?php echo e(route('track-order.index')); ?> ">Track Your Order</a>
                </h3>
                <div class="divider-role"
                     style="border: 1px solid whitesmoke; margin-bottom: 14px;  margin-top: -6px;">
                </div>
        ...
        <div class="pb-0" style="padding-top: 12px;">
            ...
            <div class="sidebarL">
                <h3 class="widget-title btnF" style="font-weight: 700;">
                    <a class="<?php echo e(Request::is('chat*')?'active-menu':''); ?>" href="<?php echo e(route('chat-with-seller')); ?>">Chat With Seller</a>
                </h3>
                <div class="divider-role"
                     style="border: 1px solid whitesmoke; margin-bottom: 14px;  margin-top: -6px;">
                </div>
            ...
            <div class=" sidebarL">
                <h3 class="widget-title btnF" style="font-weight: 700;">
                    <a class="<?php echo e((Request::is('account-ticket*') || Request::is('support-ticket*'))?'active-menu':''); ?>"
                       href="<?php echo e(route('account-tickets')); ?>"><?php echo e(trans('messages.support_ticket')); ?></a></h3>
                <div class="divider-role"
                     style="border: 1px solid whitesmoke; margin-bottom: 14px;  margin-top: -6px;">
                </div>
            </div>
...
<?php /**PATH D:\xampp-php-8.0.8\htdocs\bandharphirus.com-newdesign-2021-08-06\resources\views/web-views/partials/_profile-aside.blade.php ENDPATH**/ ?>