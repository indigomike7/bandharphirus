<?php $__env->startSection('title','Check Saldo'); ?>
    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a href="<?php echo e(route('seller.saldo.saldo')); ?>">Saldo</a></li>
            ...
            <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
							...
							Saldo : <b><?php echo e($seller->saldo); ?></b>
							</div>
							<table id="datatable"
							...
							<tbody>
							<?php ($z=$s->where('seller_id','=',$seller->id)->get()); ?>
							<?php $__currentLoopData = $z; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<tr>
								<td><?php echo e($key+1); ?>

								</td>
								<td><?php echo e($value->action); ?>

								</td>
								<td><?php echo e($value->amount); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.back-end.app-seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bandbkmp/public_html/resources/views/seller-views/saldo/saldo.blade.php ENDPATH**/ ?>