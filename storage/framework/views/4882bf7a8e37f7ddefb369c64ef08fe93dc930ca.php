            ...
            <div class="card-body">
                <div class="row mt-2">
                    ...
                    <?php else: ?>
                        ...
                        <div class="col-md-4">
                            <img src="<?php echo e(asset('storage/app/public/shop/'.$shop->image)); ?>" class="rounded-circle border"
...
<?php echo $__env->make('layouts.back-end.app-seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bandbkmp/public_html/resources/views/seller-views/shop/shopInfo.blade.php ENDPATH**/ ?>