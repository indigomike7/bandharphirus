                                ...
                                <div class="table-responsive banner_product" data-simplebar style=" padding: 0px;">
                                    <div class="d-flex d-md-block justify-content-between">
                                        <?php $__currentLoopData = $random_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php echo $__env->make('web-views.partials._inline-single-product',['product'=>$product], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <?php if($key<3 && $deal->product): ?>
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="flash_deal_product "
                                                 style="cursor: pointer;"
                                                 data-href="<?php echo e(route('product',$deal->product->slug)); ?>">
                                                    ...
                                                    <div
                                                        ...
                                                        <div>
                                                            <h6 class="flash-product-title">
                                                                <a href="<?php echo e(route('product',$deal->product->slug)); ?>"><?php echo e($deal->product['name']); ?></a>
                                                            </h6>
                                                        ...
                                                        <span
                                                            class="d-inline-block review-count align-middle mt-1 mr-1"><?php echo e($overallRating[0]); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-9 col-md-8 for-iphone-mobile">
                                <div id="carouselExampleInterval" class="carousel slide featured_deal_carosel"
                                    ...
                                    <div class="carousel-inner">
                                        <?php ($increment=0); ?>
                                        <?php while($increment<count($featured_deals->products)): ?>
                                            <div class="carousel-item <?php echo e($increment==0?'active':''); ?>"
                                                 data-interval="10000">
                                                <div class="row">
                                                    <?php if(!empty($featured_deals->products[$increment])): ?>
                                                        <div class="col-md-6">
                                                            <div
                                                                ...
                                                                <div
                                                                    ...
                                                                    data-href="<?php echo e(route('product',$featured_deals->products[$increment]->product->slug)); ?>">
                                                                            ...
                                                                            <div class="featured_product_pic "
                                                                                ...
                                                                                <a href="#" class="image_center">
                                                                                    <img style="padding: 10px"
                                                                                         src="<?php echo e(\App\CPU\ProductManager::product_image_path('thumbnail')); ?>/<?php echo e($featured_deals->products[$increment]->product['thumbnail']); ?>"
                                                                                         onerror="this.src='<?php echo e(asset('public/assets/front-end/img/image-place-holder.png')); ?>'"
                                                                                         class="d-block w-100"
                                                                                         alt="...">
                                                                                </a>
                                                                        ...
                                                                        <div class="col-8">
                                                                            <div class="featured_product_details ">
                                                                                <h3 class="featured_product-title">
                                                                                    <a class="ptr" href="#">
                                                                                        <?php echo e($featured_deals->products[$increment]->product['name']); ?>
                                                    ...
                                                    <?php endif; ?>
                                                    <?php if(!empty($featured_deals->products[$increment+1])): ?>
                                                        <div class="col-md-6 d-md-block d-sm-none for-mobile">
                                                            <div
                                                                ...
                                                                <div
                                                                    class="featured_deal_product d-flex align-items-center justify-content-between inline_product"
                                                                    data-href="<?php echo e(route('product',$featured_deals->products[$increment+1]->product->slug)); ?>">
                                                                    <div class="row">
                                                                        <div class="col-4">
                                                                            <div class="featured_product_pic "
                                                                                 style=" text-align: center;">
                                                                                <a href="#" class="image_center">
                                                                                    <img
                                                                                        src="<?php echo e(\App\CPU\ProductManager::product_image_path('thumbnail')); ?>/<?php echo e($featured_deals->products[$increment+1]->product['thumbnail']); ?>"
                                                                                        onerror="this.src='<?php echo e(asset('public/assets/front-end/img/image-place-holder.png')); ?>'"
                                                                        ...
                                                                        <div class="col-8">
                                                                            <div class="featured_product_details">
                                                                                <h3 class="featured_product-title">
                                                                                    <a class="ptr" href="#">
                                                                                        <?php echo e($featured_deals->products[$increment+1]->product['name']); ?>
                ...
                <div class="container mt-2">
                    <div class="row p-0">
                        <div class="col-md-3 p-0 text-center mobile-padding">
                            <img style="height: 29px;" src="<?php echo e(asset("storage/app/public/png/delivery.png")); ?>" alt="">
                            <div class="deal-title">3 Days <br><span>Fast Delivery</span></div>
                        </div>

                        <div class="col-md-3 p-0 text-center">
                            <img style="height: 29px;" src="<?php echo e(asset("storage/app/public/png/money.png")); ?>" alt="">
                            <div class="deal-title">Money Back <br><span>Gurrantey</span></div>
                        </div>
                        <div class="col-md-3 p-0 text-center">
                            <img style="height: 29px;" src="<?php echo e(asset("storage/app/public/png/Genuine.png")); ?>" alt="">
                            <div class="deal-title">100% Genuine<br><span>Product</span></div>
                        </div>
                        <div class="col-md-3 p-0 text-center">
                            <img style="height: 29px;" src="<?php echo e(asset("storage/app/public/png/Payment.png")); ?>" alt="">
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="view_all view-btn-div pull-right">
                            <div>
                                <a class="btn btn-outline-accent btn-sm viw-btn-a"
                                   href="<?php echo e(route('products',['data_from'=>'latest'])); ?>"><?php echo e(trans('messages.view_all')); ?>
        ...
        <div class="row pt-2 mx-n2">
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-2 col-md-3 col-sm-4 col-6 px-2 mb-3 text-center inline_product"
                     style="cursor: pointer"
                     data-href="<?php echo e(route('products',['id'=> $category['id'],'data_from'=>'category','page'=>1])); ?>">
                            ...
                            <div class="media align-items-center pt-2 pb-2  inline_product"
                                ...
                                <div class="media-body">
                                    <h6 class="widget-product-title">
                                        <a class="ptr"
                                           href="<?php echo e(route('product',$product->slug)); ?>"><?php echo e($bestSell->product['name']); ?></a>
                                    </h6>
                        ...
                        <?php if($top->product && $key<4): ?>
                            <div class="media align-items-center pt-2 pb-2 inline_product"
                                ...
                                <div class="media-body">
                                    <h6 class="widget-product-title">
                                        <a class="ptr"
                                           href="<?php echo e(route('product',$top->product->slug)); ?>"><?php echo e($top->product['name']); ?></a>
                                    </h6>
                                    <div class="widget-product-meta">
                                       <span class="text-accent">
                                            <?php echo e(\App\CPU\Helpers::currency_converter(
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-php-8.0.8\htdocs\bandharphirus.com-newdesign-2021-08-06\resources\views/web-views/home.blade.php ENDPATH**/ ?>