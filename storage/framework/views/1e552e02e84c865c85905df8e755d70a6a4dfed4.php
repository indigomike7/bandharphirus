...
<div class="content container-fluid">  <!-- Page Heading -->
    ...
    <div class="d-md-flex_ align-items-center justify-content-between mb-0">
        <div class="row">
            <div class="col-md-8">
                <h3 class="h3 mt-2 text-black-50"><?php echo e(trans('messages.product_list')); ?></h3>
            </div>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item"
                                                   href="<?php echo e(route('admin.product.edit',[$p['id']])); ?>"><?php echo e(trans('messages.Edit')); ?></a>
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bandbkmp/public_html/resources/views/admin-views/product/list.blade.php ENDPATH**/ ?>