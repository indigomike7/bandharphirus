...
<style>
 ...
 @media(max-width: 768px){
    ...
    margin-left: 8%;
        ...
        <footer class="footer appear-animate" data-animation-options="{
            ...
            <div class="container">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="widget widget-about">
                                <a href="<?php echo e(route('home')); ?>" class="logo-footer">
                                    <img src="<?php echo e(asset('public/assets')); ?>/images/logo.png" alt="logo-footer" width="144"
                                        height="45" />
                                </a>
                ...
                <?php if(isset($social_media)): ?>
                    ...
                    <span class="social-media">
                        <a class="social-btn sb-light sb-<?php echo e($item->name); ?> ml-4 mb-4" href="<?php echo e($item->link); ?>" style="color: blue; width:30px; height:30px;"><i
                                class="<?php echo e($item->icon); ?> fa-2x" aria-hidden="true" style="margin:0 auto;margin-top:5px;"></i></a>
					</span>
            ...
            <div class="col-lg-3 col-sm-6">
                            <div class="widget">
                <h6  class="widget-title"><?php echo e(trans('messages.special')); ?></h6>
                <ul class="widget-list">
                    ...
                    <?php endif; ?>
                    <li><a  href="<?php echo e(route('products',['data_from'=>'featured','page'=>1])); ?>"><?php echo e(trans('messages.featured_products')); ?></a>
                    </li>
                    <li><a  href="<?php echo e(route('products',['data_from'=>'latest','page'=>1])); ?>"><?php echo e(trans('messages.latest_products')); ?></a>
                    </li>
                    <li<a  href="<?php echo e(route('products',['data_from'=>'best-selling','page'=>1])); ?>"><?php echo e(trans('messages.best_selling_product')); ?></a>
                    </li>
                    <li><a  href="<?php echo e(route('products',['data_from'=>'top-rated','page'=>1])); ?>"><?php echo e(trans('messages.top_rated_product')); ?></a>
                    </li>
                    <li><a href="<?php echo e(route('brands')); ?>"><?php echo e(trans('messages.all_brand')); ?></a></li>
                    <li><a href="<?php echo e(route('categories')); ?>"><?php echo e(trans('messages.all_category')); ?></a>
                    </li>
                </ul>
				</div>
            </div>
            ...
            <div class="col-lg-3 col-sm-6"">
                            <div class="widget">
                <h6  class="widget-title"><?php echo e(trans('messages.account&shipping_info')); ?></h6>
                <?php if(auth('customer')->check()): ?>
                    <ul class="widget-list">
                        ...
                        <li><a                                                        href="<?php echo e(route('account-address')); ?>"><?php echo e(trans('messages.address')); ?></a>
                        </li>
                        <li><a
                ...
                <?php else: ?>
                    <ul class="widget-list">
                        <li><a   href="<?php echo e(route('customer.auth.login')); ?>"><?php echo e(trans('messages.profile_info')); ?></a>
                        </li>
                        <li><a   href="<?php echo e(route('customer.auth.login')); ?>"><?php echo e(trans('messages.wish_list')); ?></a>
                        </li>
                        
                        <li><a href="<?php echo e(route('track-order.index')); ?>"><?php echo e(trans('messages.track_order')); ?></a>
                        </li>
                        <li><a href="<?php echo e(route('customer.auth.login')); ?>"><?php echo e(trans('messages.address')); ?></a>
                        </li>
                        <li><a href="<?php echo e(route('customer.auth.login')); ?>"><?php echo e(trans('messages.support_ticket')); ?></a>
                        </li>
            ...
            <div class="col-lg-3 col-sm-6"">
                            <div class="widget">
                                <h4 class="widget-title"><?php echo e(trans('messages.about_us')); ?></h4>
                                <ul class="widget-list">
                                    <li><a href="<?php echo e(route('about-us')); ?>"><?php echo e(trans('messages.about_company')); ?></a></li>
                                    <li><a href="<?php echo e(route('about-us')); ?>"><?php echo e(trans('messages.faq')); ?></a></li>
                                    <li><a href="<?php echo e(route('contacts')); ?>"><?php echo e(trans('messages.contact_us')); ?></a></li>
                                </ul>
                            </div>
            </div>
                ...
                <div class="footer-middle">
					...
					<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="category-box">
                            <h6 class="category-name"> <?php echo e($category['name']); ?>:</h6>
    ...
    <div class="sticky-footer sticky-content fix-bottom">
        ...
        <a href="<?php echo e(route('user-account')); ?>" class="sticky-link">
            <i class="w-icon-account"></i>
            <p>Account</p>
        </a>
        <div class="cart-dropdown dir-up">
            <a href="<?php echo e(route('shop-cart')); ?>" class="sticky-link">
...
<!--            <div class="dropdown-box">
        ...
        <div class="header-search hs-toggle dir-up">
            ...
            <form action="<?php echo e(route('products')); ?>" class="input-wrapper">
    ...
    <div class="mobile-menu-wrapper">
        ...
        <div class="mobile-menu-container scrollable">
            <form action="<?php echo e(route('products')); ?>" method="get" class="input-wrapper">
                <input type="text" class="form-control" name="name" autocomplete="off" placeholder="Search"
                    required />
					<input type="hidden" name="data_from" value="search">
					<input type="hidden" name="page" value="1">
					...
					<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            ...
                            <ul>
								<?php $__currentLoopData = $category['childes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <h4><?php echo e($subCategory['name']); ?></h4>
									<?php if($subCategory->childes->count()>0): ?>
										<ul>
											...
											<?php $__currentLoopData = $subCategory['childes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subSubCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<li><a href="<?php echo e(route('products',['id'=> $subSubCategory['id'],'data_from'=>'category','page'=>1])); ?>"><?php echo e($subSubCategory['name']); ?></a>
												</li>
											<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										</ul>
									<?php endif; ?>
...
<!-- Footer -->
<?php /**PATH D:\xampp-php-8.0.8\htdocs\bandharphirus.com-newdesign-2021-08-06\resources\views/layouts/front-end/partials/_footer.blade.php ENDPATH**/ ?>