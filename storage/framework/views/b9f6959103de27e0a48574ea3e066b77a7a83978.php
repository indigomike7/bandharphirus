    ...
    <section class="bg-transparent mt-4 mb-4">
        <div class="container">
            <div class="row ">
				...
				<div class="col-md-4">
				<a href="<?php echo e(route('collectionid',[$value->slug])); ?>">
				<h3><?php echo e($value->name); ?></h3></a>
				<a href="<?php echo e(route('collectionid',[$value->slug])); ?>">
				<?php if($value->pictures!=null || $collection->pictures!=""): ?>
					<?php $__currentLoopData = json_decode($value->pictures); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2 => $photo2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<div class="card">
								<div class="card-body">
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bandbkmp/public_html/resources/views/web-views/collection.blade.php ENDPATH**/ ?>