    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form class="product-form" action="<?php echo e(route('admin.contest2.update')); ?>" method="post" enctype="multipart/form-data"
                      id="product_form">
                    <?php echo csrf_field(); ?>
                    <div class="card">
...
<?php endif; ?>                        <div class="card-body">
                            <div class="form-group">
								...
								<option value="<?php echo e($value->id); ?>" <?php echo e(($value->id==$contest->contestcat) ? " selected='selected' " : ""); ?>><?php echo e($value->category); ?></option>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								</select>
                            </div>
                            <div class="form-group">
...
<?php $__env->startPush('script'); ?>
    ...
    <script>
        $('#product_form').submit(function (e) {
            ...
            $.post({
                url: '<?php echo e(route('admin.contest2.update')); ?>',
                data: formData,
                contentType: false,
                processData: false,
                success: function (data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bandbkmp/public_html/resources/views/admin-views/contest/edit.blade.php ENDPATH**/ ?>