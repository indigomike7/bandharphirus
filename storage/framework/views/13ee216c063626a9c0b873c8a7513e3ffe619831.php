    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a href="<?php echo e(route('admin.premium2.settings')); ?>">Premium</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form class="product-form" action="<?php echo e(route('admin.premium2.settingsupdate')); ?>" method="post" enctype="multipart/form-data"
                      id="product_form">
                    <?php echo csrf_field(); ?>
                    <div class="card">
...
<?php endif; ?>                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="number" name="cost_30_days" value="<?php echo e($ps->cost_30_days); ?>" class="form-control" id="name" placeholder="10000">
                            </div>

                            <div class="form-group">
                                <label for="name">90 Days</label>
                                <input type="text" name="cost_90_days" value="<?php echo e($ps->cost_90_days); ?>" class="form-control" id="name" placeholder="25000">
                            </div>
                            <div class="form-group">
                                <label for="name">180 Days</label>
                                <input type="text" name="cost_180_days" value="<?php echo e($ps->cost_180_days); ?>" class="form-control" id="name" placeholder="50000">
                            </div>
                            <div class="form-group">
                                <label for="name">365 Days</label>
                                <input type="text" name="cost_365_days" value="<?php echo e($ps->cost_365_days); ?>" class="form-control" id="name" placeholder="100000">
                            </div>
                            <div class="form-group">
                                <div class="row">
...
<?php $__env->startPush('script'); ?>
    ...
    <script>
        $('#product_form').submit(function (e) {
            ...
            $.post({
                url: '<?php echo e(route('admin.premium2.settingsupdate')); ?>',
                data: formData,
                contentType: false,
                processData: false,
                success: function (data) {
                    if (data.errors) {
                        ...
                        setInterval(function () {
                            location.href = '<?php echo e(route("admin.premium2.settings")); ?>';
                        }, 2000);
                    }
                }
            });
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bandbkmp/public_html/resources/views/admin-views/premium/settings.blade.php ENDPATH**/ ?>