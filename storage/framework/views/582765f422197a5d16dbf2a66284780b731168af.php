    ...
    <section class="bg-transparent mt-4 mb-4">
        <div class="container">
            <div class="row ">
				...
				<div class="row">
				<div class="col-md-4">
				<a href="<?php echo e(route('educationcategory')); ?>">Education</a> / <?php echo e($ec->category); ?>

				<h3><?php echo e($ec->category); ?></h3></a>
				<a href="<?php echo e(route('educationcategoryid',[$ec->id])); ?>">
				<?php if($ec->picture!=null || $ec->picture!=""): ?>
					<?php $__currentLoopData = json_decode($ec->picture); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2 => $photo2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<div class="card">
								<div class="card-body">
				...
				<div class="col-md-4">
				<?php echo e($i); ?>. <a href="<?php echo e(route('educationid',[$value->id])); ?>"><?php echo e($value->title); ?></a>
				</div>
				<?php ($i++); ?>
				<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				</div
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bandbkmp/public_html/resources/views/web-views/educationcategoryid.blade.php ENDPATH**/ ?>