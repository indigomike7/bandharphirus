    ...
    <header id="header"
        ...
        <div class="navbar-nav-wrap">
            <div class="navbar-brand-wrapper">
                ...
                <a class="navbar-brand" href="<?php echo e(route('seller.dashboard')); ?>" aria-label="">
                        ...
                        <div class="hs-unfold">
                            ...
                            <div id="accountNavbarDropdown"
                                ...
                                <a class="dropdown-item"
                                   href="<?php echo e(route('seller.saldo.saldo')); ?>">
                                    <span class="text-truncate pr-2" title="Settings"><?php echo e($seller->saldo); ?></span>
                                </a>

								<?php if($seller->premium_until > date("Y-m-d")): ?>
                                <a class="dropdown-item"
                                   href="<?php echo e(route('seller.premium.premium')); ?>">
                                    <span class="text-truncate pr-2" title="Settings">PREMIUM!!</span>
                                </a>
								<?php endif; ?>
                                <a class="dropdown-item"
                                   href="<?php echo e(route('seller.premium.update')); ?>">
                                    <span class="text-truncate pr-2" title="Settings">Become Premium</span>
                                </a>

                                <a class="dropdown-item"
                                   href="<?php echo e(route('seller.saldo.update')); ?>">
...
<?php /**PATH /home/bandbkmp/public_html/resources/views/layouts/back-end/partials-seller/_header.blade.php ENDPATH**/ ?>