<div class="d-table table-fixed w-100">
    ...
    <a class="d-table-cell cz-handheld-toolbar-item" href="<?php echo e(route('wishlists')); ?>">
        ...
        <span class="cz-handheld-toolbar-label">Wishlist (<span class="countWishlist"><?php echo e(session()->has('wish_list')?count(session('wish_list')):0); ?></span>)</span></a>
...
<?php /**PATH D:\xampp-php-8.0.8\htdocs\bandharphirus.com-newdesign-2021-08-06\resources\views/layouts/front-end/partials/_toolbar.blade.php ENDPATH**/ ?>