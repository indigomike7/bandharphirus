        ...
        <div class="row align-items-center mb-3">
            <div class="col-sm">
                <h1 class="page-header-title"><?php echo e(trans('messages.contest')); ?> <span
                        class="badge badge-soft-dark ml-2"><?php echo e(\App\Model\Contest::where('seller_id',0)->count()); ?></span>
                </h1>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
						...
						<p style="text-align:right;"><a href="<?php echo e(route('admin.contest2.adminadd')); ?>">Add New Contest</a></p>
                    </div>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item"
                                                       href="<?php echo e(route('admin.contest2.edit',[$detail['id']])); ?>"> Edit</a>
                                                    <a class="dropdown-item"
                                                       href="<?php echo e(route('admin.contest2.listmanage',[$detail['id']])); ?>"> Manage</a>
                                                    <a class="dropdown-item"
                                                       href="<?php echo e(route('admin.contest2.delete',[$detail['id']])); ?>"> Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-php-8.0.8\htdocs\bandharphirus.com-newdesign-2021-08-06\resources\views/admin-views/contest/list.blade.php ENDPATH**/ ?>