    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a href="<?php echo e(route('admin.contest2.category')); ?>">Contest Category</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form class="product-form" action="<?php echo e(route('admin.contest2.categoryupdate')); ?>" method="post" enctype="multipart/form-data"
                      id="product_form">
                    <?php echo csrf_field(); ?>
                    <div class="card">
...
<?php endif; ?>                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="category" value="<?php echo e($contest->category); ?>" class="form-control" id="name" placeholder="Ex : Namele">
                            </div>
...
<?php $__env->startPush('script'); ?>
    ...
    <script>
        $('#product_form').submit(function (e) {
            ...
            $.post({
                url: '<?php echo e(route('admin.contest2.categoryupdate')); ?>',
                data: formData,
                contentType: false,
                processData: false,
                success: function (data) {
                    if (data.errors) {
                        ...
                        toastr.success('Contest category updated successfully!', {
                            CloseButton: true,
                            ProgressBar: true
                        });
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bandbkmp/public_html/resources/views/admin-views/contest/categoryedit.blade.php ENDPATH**/ ?>