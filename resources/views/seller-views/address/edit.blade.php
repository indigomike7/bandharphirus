    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a href="{{route('seller.address.list')}}">Address</a></li>
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-2">
            <h1 class="h3 mb-0 text-black-50">{{trans('messages.address')}}</h1>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form class="product-form" action="{{route('seller.address.update')}}" method="post" enctype="multipart/form-data"
                      id="product_form">
                    @csrf
                    <div class="card">
...
@push('script')
    ...
    <script>
        $('#product_form').submit(function (e) {
            ...
            $.post({
                url: '{{route('seller.address.update')}}',
                data: formData,
                contentType: false,
                processData: false,
                success: function (data) {
                    if (data.errors) {
                        ...
                        setInterval(function () {
                            location.href = '{{route('seller.address.list')}}';
                        }, 2000);
                    }
                }
            });
