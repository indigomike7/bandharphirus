                      ...
                      <div class="card-body">
						<input type="hidden" name="id" id="id" value="{{$b->id}}">
                            ...
                            <div class="form-group">
								...
								<option value="{{$value->id}}" {{($value->id==$b->category) ? " selected='selected' " : ""}}>{{$value->name}}</option>
								@endforeach
								</select>
                            </div>
                            <div class="form-group">
                      ...
                      id="product_form_edit{{$value->id}}">
							  ...
							  <a href="{{route('seller.barter.deleteproductbarter',[$value->id])}}">Delete This Product Barter</a><br/><br/>
								...
								<div class="form-group">
									...
									<input type="number" name="quantity" value="{{$value->quantity}}" class="form-control" id="quantity" placeholder="2">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="row" id="cobadb{{$value->id}}" name="cobadb{{$value->id}}"></div>
									...
									<script type="text/javascript">
											$(function () {
												$("#cobadb{{$value->id}}").spartanMultiImagePicker({
													fieldName: 'imagesdb{{$value->id}}[]',
													maxCount: 4,
													rowHeight: 'auto',
									...
									<script>
										$('#product_form_edit{{$value->id}}').submit(function (e) {
											e.preventDefault();
                      ...
                      id="product_form_edit_buy{{$value->id}}">
							  ...
							  <a href="{{route('seller.barter.deleteproductbuy',[$value->id])}}">Delete This Product Demand</a><br/><br/>
								...
								<div class="form-group">
									...
									<div  class="p-2 border border-dashed"  style="max-width:430px;">'
									<div class="row" id="cobadbbuy{{$value->id}}" name="cobadb{{$value->id}}"></div>
									@if($value->picture!=null)
                                    @foreach (json_decode($value->picture) as $key => $photo)
                                            <div class="col-6">
                                                <div class="card">
									...
									<script type="text/javascript">
											$(function () {
												$("#cobadbbuy{{$value->id}}").spartanMultiImagePicker({
													fieldName: 'imagesdbbuy{{$value->id}}[]',
													maxCount: 4,
													rowHeight: 'auto',
													groupClassName: 'col-6',
													maxFileSize: '',
									...
									<script>
										$('#product_form_edit_buy{{$value->id}}').submit(function (e) {
											e.preventDefault();
											e.stopImmediatePropagation();
											for ( instance in CKEDITOR.instances ) {
												CKEDITOR.instances[instance].updateElement();
                      ...
                      id="amount_sell_edit{{$value->id}}">
							  ...
							  <a href="{{route('seller.barter.deleteamountbarter',[$b->id])}}">Delete This Amount Barter</a><br/><br/>
								<div class="form-group">
									...
									<script>
										$('#amount_sell_edit{{$value->id}}').submit(function (e) {
											e.preventDefault();
											e.stopImmediatePropagation();
											for ( instance in CKEDITOR.instances ) {
												CKEDITOR.instances[instance].updateElement();
                      ...
                      id="amount_buy_edit{{$value->id}}">
							  ...
							  <a href="{{route('seller.barter.deleteamountbuy',[$b->id])}}">Delete This Amount Demand</a><br/><br/>
								<div class="form-group">
									...
									<script>
										$('#amount_buy_edit{{$value->id}}').submit(function (e) {
											e.preventDefault();
											e.stopImmediatePropagation();
											for ( instance in CKEDITOR.instances ) {
												CKEDITOR.instances[instance].updateElement();
