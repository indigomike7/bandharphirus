<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="wf-poppins-n4-active wf-poppins-n5-active wf-poppins-n6-active wf-poppins-n8-active wf-poppins-n7-active wf-active skrollr skrollr-desktop">
<head>
    <title>
        @yield('title')
    </title>
    ...
    <link rel="preload" href="{{asset('/public/assets/vendor')}}/fontawesome-free/webfonts/fa-regular-400.woff2" as="font" type="font/woff2" crossorigin="anonymous">
    <link rel="preload" href="{{asset('/public/assets/vendor')}}/fontawesome-free/webfonts/fa-solid-900.woff2" as="font" type="font/woff2" crossorigin="anonymous">
    <link rel="preload" href="{{asset('/public/assets/vendor')}}/fontawesome-free/webfonts/fa-brands-400.woff2" as="font" type="font/woff2" crossorigin="anonymous">
    <link rel="preload" href="{{asset('/public/assets/fonts')}}/wolmart87d5.ttf?png09e" as="font" type="font/ttf" crossorigin="anonymous">

    <!-- Vendor CSS -->
    <link rel="stylesheet" type="text/css" href="{{asset('public/assets/vendor')}}/fontawesome-free/css/all.min.css">

    <!-- Plugins CSS -->
    <link rel="stylesheet" type="text/css" href="{{asset('/public/assets/vendor')}}/owl-carousel/owl.carousel.min.css">
    <link rel="stylesheet" type="text/css" href="{{asset('/public/assets/vendor')}}/animate/animate.min.css">
    <link rel="stylesheet" type="text/css" href="{{asset('/public/assets/vendor')}}/magnific-popup/magnific-popup.min.css">

    <link rel="stylesheet" media="screen" href="{{asset('/public/assets/front-end')}}/css/theme.min.css">
    <!-- Default CSS -->
    <link rel="stylesheet" type="text/css" href="{{asset('/public/assets')}}/css/demo1.min.css">
...
<!-- Vendor scrits: js libraries and plugins-->
    ...
    <script src="{{asset('/public/assets/vendor')}}/jquery.plugin/jquery.plugin.min.js"></script>
    ...
    <script src="{{asset('/public/assets/vendor')}}/zoom/jquery.zoom.min.js"></script>
    <script src="{{asset('/public/assets/vendor')}}/jquery.countdown/jquery.countdown.min.js"></script>
    <script src="{{asset('/public/assets/vendor')}}/skrollr/skrollr.min.js"></script>
