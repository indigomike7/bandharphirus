                ...
                <div  class="dropdown">
                    ...
                    <div class="dropdown-box">
                        ...
                        @foreach(json_decode($language['value'],true) as $data)
                            @if($data['code']==$locale)
                                <a href="{{route('lang',[$data['code']])}}"><img class="mr-2" width="20"
                        ...
                        @if($seller_registration)
                                <a href="javascript:;">
                                {{ trans('messages.Seller')}}  {{ trans('messages.zone')}}
                            <div class="dropdown-box">
                                    <a class="dropdown-item pb-1" href="{{route('shop.apply')}}">
                                        {{ trans('messages.Become a')}} {{ trans('messages.Seller')}}
                                    </a>
                                    <a class="dropdown-item pb-1" href="{{route('seller.auth.login')}}">
                                        {{ trans('messages.Seller')}}  {{ trans('messages.login')}}
                                    </a>
							</div>
                        @endif
						</div>
                        ...
                        <a href="{{route('about-us')}}" class="d-lg-show">{{trans('messages.about_company')}}</a>
                        <a href="blog.html" class="d-lg-show">Blog</a>
                        <a href="{{route('contacts')}}" class="d-lg-show">{{trans('messages.contact_us')}}</a>
                    ...
                    @else
                        <a href="{{route('customer.auth.login')}}" class="d-lg-show login sign-in"><i class="w-icon-account"></i>{{trans('messages.sing_in')}}</a>
                            <span class="delimiter d-lg-show">/</span>
                        <a href="{{route('customer.auth.register')}}" class="ml-0 d-lg-show login register">{{trans('messages.sing_up')}}</a>
					@endif
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="header-left mr-md-4">
                        ...
                        <a href="{{route('home')}}" class="logo ml-lg-0">
                            <img src="{{asset('public/assets')}}/images/logo.png" alt="logo" width="144" height="45" />
                        </a>
						<style>
						.btn-search{border: 2px solid #336699; border-left: none;}
						</style>
                        <form method="get" action="{{route('products')}}" class="header-search hs-expanded hs-round d-none d-md-flex input-wrapper">
...
.font-weight-bolder {
    ...
    line-height: 1.7;
                            ...
                            <a class="cart-toggle label-down link" href="{{route('wishlists')}}">
							<i class="w-icon-heart"> 
							<span class="cart-count">{{session()->has('wish_list')?count(session('wish_list')):0}}</span>
                            </i>
            ...
            @if(session()->has('cart') && count( session()->get('cart')) > 0)
                    @foreach(session('cart') as $key => $cartItem)
                                    ...
                                    <div class="product product-cart">
                                        <div class="product-detail">
                                            <a href="{{route('product',$cartItem['slug'])}}" class="product-name">{{$cartItem['name']}}</a>
                                            <div class="price-box">
					...
					@endif
                                ...
                                <div class="cart-action">
                                    <a href="{{route('shop-cart')}}" class="btn btn-dark btn-outline btn-rounded">View More</a>
                                    <a href="{{route('checkout-details')}}" class="btn btn-primary  btn-rounded">Checkout</a>
                                </div>
                            </div>
                            <!-- End of Dropdown Box -->
                        </div>
