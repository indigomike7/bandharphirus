...
@endif
  ...
  <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/attribute*') || Request::is('admin/product*'))?'active':''}}">
      ...
      <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
          style="display: {{(Request::is('admin/attribute*') || Request::is('admin/contest2*'))?'block':''}}">
          <li class="nav-item {{Request::is('admin/education/category')?'active':''}}">
              <a class="nav-link " href="{{route('admin.education.category',['in_house'])}}" title="InHouse Products">
                  <span class="tio-circle nav-indicator-icon"></span>
                  <span class="text-truncate">Education Category</span>
              </a>
          </li>
          <li class="nav-item {{Request::is('admin/education/list')?'active':''}}">
              <a class="nav-link " href="{{route('admin.education.list',['in_house'])}}" title="InHouse Products">
                  <span class="tio-circle nav-indicator-icon"></span>
  ...
  <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/attribute*') || Request::is('admin/product*'))?'active':''}}">
      ...
      <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
          style="display: {{(Request::is('admin/attribute*') || Request::is('admin/contest2*'))?'block':''}}">
          <li class="nav-item {{Request::is('admin/collection/index')?'active':''}}">
              <a class="nav-link " href="{{route('admin.collection.index',['in_house'])}}" title="InHouse Products">
                  <span class="tio-circle nav-indicator-icon"></span>
  ...
  <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/attribute*') || Request::is('admin/product*'))?'active':''}}">
      ...
      <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
          style="display: {{(Request::is('admin/attribute*') || Request::is('admin/contest2*'))?'block':''}}">
          <li class="nav-item {{Request::is('admin/contest2/list')?'active':''}}">
              <a class="nav-link " href="{{route('admin.premium2.settings',['in_house'])}}" title="InHouse Products">
                  <span class="tio-circle nav-indicator-icon"></span>
  ...
  <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/attribute*') || Request::is('admin/product*'))?'active':''}}">
      ...
      <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
          style="display: {{(Request::is('admin/attribute*') || Request::is('admin/contest2*'))?'block':''}}">
          <li class="nav-item {{Request::is('admin/contest2/list')?'active':''}}">
              <a class="nav-link " href="{{route('admin.saldopurchased.settings',['in_house'])}}" title="InHouse Products">
                  <span class="tio-circle nav-indicator-icon"></span>
