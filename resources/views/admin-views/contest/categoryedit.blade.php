    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a href="{{route('admin.contest2.category')}}">Contest Category</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form class="product-form" action="{{route('admin.contest2.categoryupdate')}}" method="post" enctype="multipart/form-data"
                      id="product_form">
                    @csrf
                    <div class="card">
...
@endif                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="category" value="{{$contest->category}}" class="form-control" id="name" placeholder="Ex : Namele">
                            </div>
...
@push('script')
    ...
    <script>
        $('#product_form').submit(function (e) {
            ...
            $.post({
                url: '{{route('admin.contest2.categoryupdate')}}',
                data: formData,
                contentType: false,
                processData: false,
                success: function (data) {
                    if (data.errors) {
                        ...
                        setInterval(function () {
                            location.href = '{{route('admin.contest2.category')}}';
                        }, 2000);
                    }
                }
            });
