...
@section('content')
    ...
    <div class="content container-fluid">
        <div class="row align-items-center mb-3">
            <div class="col-sm">
                <h1 class="page-header-title">Barter <span
                        class="badge badge-soft-dark ml-2">{{\App\Model\SellerBarterOrder::where('seller_id_demand',0)->count()}}</span>
                </h1>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item"
                                                       href="{{route('admin.barter.buydetail',[$detail['id']])}}"> Manage</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
        ...
        <div class="row" style="margin-top: 20px">
			<div class="col-md-6">
			Please add your primary address firstly, before you can manage barter buy!! Add <a href="{{route('admin.address.add')}}">Here</a>
			</div>
		</div>
		@endif
    </div>
