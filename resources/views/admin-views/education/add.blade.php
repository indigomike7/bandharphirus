    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form class="product-form" action="{{route('admin.education.addnew2')}}" method="post" enctype="multipart/form-data"
                      id="product_form">
                    @csrf
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="title" value="{{old('title')}}" class="form-control" id="name" placeholder="Ex : Kontes untuk memperingati HUT RI">
                            </div>
...
@push('script')
    ...
    <script>
        $('#product_form').submit(function (e) {
            ...
            $.post({
                url: '{{route('admin.education.addnew2')}}',
                data: formData,
                contentType: false,
                processData: false,
                success: function (data) {
