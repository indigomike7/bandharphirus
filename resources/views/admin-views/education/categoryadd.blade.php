...
@section('title','Add New Education Category')
    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form class="product-form" action="{{route('admin.education.categoryaddnew2')}}" method="post" enctype="multipart/form-data"
                      id="product_form">
                    @csrf
                    <div class="card">
                       ...
                       <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="category" value="{{old('category')}}" class="form-control" id="category" placeholder="Ex : Kontes untuk memperingati HUT RI">
                            </div>
...
@push('script')
    ...
    <script>
        $('#product_form').submit(function (e) {
            ...
            $.post({
                url: '{{route('admin.education.categoryaddnew2')}}',
                data: formData,
                contentType: false,
                processData: false,
                success: function (data) {
