...
<div class="content container-fluid">
    ...
    <div class="row" style="padding-bottom: 20px">
        ...
        <div class="col-md-6 pt-4">
            <div class="card">
                <div class="card-body" style="padding: 20px">
                    <h5 class="text-center">{{trans('messages.Tripay')}}</h5>
                    @php($config=\App\CPU\Helpers::get_business_settings('tripay'))
                    <form action="{{route('admin.business-settings.payment-method.update',['tripay'])}}"
                          method="post">
                        @csrf
                        @if(isset($config))
                            <div class="form-group mb-2">
                                <label class="control-label">{{trans('messages.Tripay')}}</label>
                            </div>
                            <div class="form-group mb-2 mt-2">
                                <input type="radio" name="status" value="1" {{$config['status']==1?'checked':''}}>
                                <label style="padding-left: 10px">{{trans('messages.Active')}}</label>
                            ...
                            <div class="form-group mb-2">
                                <label style="padding-left: 10px">{{trans('messages.tripay_api')}}  </label><br>
                                <input type="text" class="form-control" name="tripay_api"
                                       value="{{env('APP_MODE')=='demo'?'':$config['tripay_api']}}">
                            </div>

                            <div class="form-group mb-2">
                                <label style="padding-left: 10px">{{trans('messages.tripay_private_key')}}</label><br>
                                <input type="text" class="form-control" name="tripay_private_key"
                                       value="{{env('APP_MODE')=='demo'?'':$config['tripay_private_key']}}">
                            </div>
                            <button type="{{env('APP_MODE')!='demo'?'submit':'button'}}"
                                    onclick="{{env('APP_MODE')!='demo'?'':'call_demo()'}}"
                                    class="btn btn-primary mb-2">{{trans('messages.save')}}</button>
