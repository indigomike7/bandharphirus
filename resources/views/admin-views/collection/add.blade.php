    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form class="product-form" action="{{route('admin.collection.store')}}" method="post" enctype="multipart/form-data"
                      id="product_form">
                    @csrf
                    <div class="card">
...
@endif                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{old('name')}}" class="form-control" id="category" placeholder="Ex : Asian">
                            </div>
...
@push('script')
    ...
    <script>
        $('#product_form').submit(function (e) {
            ...
            $.post({
                url: '{{route('admin.collection.store')}}',
                data: formData,
                contentType: false,
                processData: false,
                success: function (data) {
