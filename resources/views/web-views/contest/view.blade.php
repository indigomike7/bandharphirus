...
@endif                        <div class="card-body">
                ...
                <form class="product-form" action="{{route('admin.contest2.updatemanage')}}" method="post" enctype="multipart/form-data"
                      id="product_form">
                    <div class="card mt-2">
                        <div class="card-body">
                            <div class="form-group">
...
@push('script')
    ...
    <script>
        $('#product_form').submit(function (e) {
            ...
            $.post({
                url: '{{route('admin.contest2.updatemanage')}}',
                data: formData,
                contentType: false,
                processData: false,
                success: function (data) {
                    if (data.errors) {
                        ...
                        setInterval(function () {
                            location.href = '{{route('admin.contest2.listmanage',$contest->id)}}';
                        }, 2000);
                    }
                }
            });
