...
class AddressController extends Controller
{
    function list() 
	{
            ...
            $a = SellerAddress::where(['seller_id' => auth('seller')->id()])->orderBy('created_at', 'desc')->get();

        return view('seller-views.address.list', compact('a','seller'));
    }
    public function edit($id)
    {
			$seller = Seller::find(auth('seller')->id());
        $a= SellerAddress::find($id);
        return view('seller-views.address.edit', compact('a','seller'));

    }

    function add() {
			$seller = Seller::find(auth('seller')->id());
        return view('seller-views.address.add',compact('seller'));
    }
