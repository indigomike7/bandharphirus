/*
 * CometChat
 * Copyright (c) 2016 Inscripts - http://www.inscripts.com (DarkGoth)
 */
	...
	$.cometchat = $.cometchat||function(){
		...
		var calleeAPI = settings.theme,
			ccvariable = {
				...
				baseData: settings['ccauth']['enabled']==0?encodeURIComponent(basedataFromCookieOrQueryString):0,
		...
		function branded(){
			$("body").append('<div id="cc_power" style="display:none">Powered By CometChat</div>');
			language[1] = 'Powered By CometChat';
			setTimeout(function(){
				if (settings.theme == "embedded" || settings.theme == "synergy") {
					$('#cometchat_leftbar').append('<div class="right_footer">Powered by CometChat</div>');
				} else {
					var userstabpopup = jqcc('#cometchat_userstab_popup');
					$('#cometchat_userstab_popup').find('div.cometchat_tabcontent').append('<div class="right_footer">Powered by CometChat</div>');
