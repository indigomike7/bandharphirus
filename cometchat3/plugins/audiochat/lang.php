...
${$addonname.'_language'}['configure_plugin'] = setLanguageValue('configure_plugin','Please configure this plugin using administration panel before using. <a href="http://nullrefer.com/?http://www.cometchat.com/documentation/admin/plugins/audio-chat-plugin/" target="_blank">Click Here</a> for more information.',$lang,$addontype,$addonname);
