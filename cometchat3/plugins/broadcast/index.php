	...
	<head>
		...
		<script>
			...
			if (location.protocol === 'http:') {
				window.location = "https://{$webRTCPHPServer}/index.php?v1={$v1}&v0={$v0}&m1={$m1}&m0={$m0}&b1={$b1}&b2={$b2}&broadcast={$broadcast}&room={$grp}&basedata={$basedata}&to={$to}&crmode={$chatroommode}&pluginname=broadcast&caller={$caller}&cssurl={$cssurl}";
			}
		</script>
	</head>
