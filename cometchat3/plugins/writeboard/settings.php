                ...
                <div class="card-block">
                 <form style="height:100%" action="?module=dashboard&action=loadexternal&type=plugin&name=whiteboard&process=true" method="post">
		            ...
		            <div class="col-md-6">
		             ...
		             <div class="col-md-6">
			              <input class="form-control" style="width:75%;" type="text"  name="writebWidth" value="$writebWidth">
		            </div>
		          </div>
		            ...
		            <div class="col-md-6">
		             ...
		             <div class="col-md-6">
			              <input class="form-control" style="width:75%;" type="text" name="writebHeight" value="$writebHeight">
		            </div>
		          </div>
