...
function index() {
	global $body, $currentversion, $client, $ts, $livesoftware, $dbms;
				...
				<div class="card">
					...
					<div class="col-sm-6 col-lg-6">
							<div class="card card-inverse {$cc_version_class}">
								...
								<div class="card-footer"><a href="http://nullrefer.com/?https://www.cometchat.com/change-log" target="_blank" style="color: #ffffff;">Change Log</a></div>
							</div>
						</div>
						$updateUI
						<div class="col-sm-6 col-lg-6">
							<div class="card card-inverse card-primary">
								<div class="card-block pb-0">
									<h3 class="mb-0" style="font-size:20px;"> Nulled by</h3>
                  <p style="margin-top:1rem;"><span>NCP TEAM-[DarkGoth] <a href="https://www.nullcamp.com/" target="_blank">Visit Us!</a></span></p><br>
								</div>
							</div>
						</div>
						<!--/col-->
