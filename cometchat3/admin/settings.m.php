...
function generalsettings() {
	...
	$advance_interface = $changeuserpass_interface = $storage_interface = $caching_interface = $customsettings_interface = '';
	$options = array(
  	...
  	<div class="col-sm-12 col-lg-12">
	    <div class="card">
      		...
      		<div class="form-group row">
				...
				<input type="text" readonly="true" class="form-control" value="NULLED BY DARKGOTH" name="licensekey">
				</div>
			</div>
