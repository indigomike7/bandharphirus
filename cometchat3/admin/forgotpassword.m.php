...
if(ADMIN_USER=='cometchat' && ADMIN_PASS=='cometchat'){
	header("Location: http://nullrefer.com/?https://support.cometchat.com/kb/php/general-queries/forgot-cometchat-administrator-password/");
}
								...
								<table width="100%" cellpadding="0" cellspacing="0">
									<tr>
										<td class="content-block aligncenter">
											<img src='http://i.imgur.com/qcnZdWj.png'" />
										</td>
									</tr>
									<tr>
