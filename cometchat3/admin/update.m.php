		...
		<div class="card-block"><br>
		        <div class="note note-success">
					<ol style="padding-left:10px;">
			    		<li>If you face any issue with the update, please contact our to assist you.</li>
...
function updateNow(){
	global $body, $cms, $ts, $update, $currentversion, $settings, $latest_vesion;
	...
	<div class="row">
		...
		<div class="col-sm-4 col-lg-4">
			...
			<div class="card-block"><br>
			        <div class="note note-success">
						<ol style="padding-left:10px;">
				    		<li>If you face any issue with the update, please contact our support team to assist you.</li>
				    		<li>This feature is currently in beta. We recommend proceeding only after you have taken a complete backup of your server/site.</li>
				    	</ol>
			        </div>
		        </div>
...
<script>
	jQuery(function() {
		...
		jQuery("#cancel-btn").click(function(){
			$('#error_msg').hide();
			alert('Please take the help of our support team to update.');
		});
